...
window.I18N_LOCALES['en'] = {
  ...
  // Model Management
  // ============================================================
  'models.title': 'Model Management - Claude Code & Codex Proxy',
  'models.createVirtualModel': 'Create Virtual Model',
  'models.editVirtualModel': 'Edit Virtual Model',
  'models.virtualModels': 'Virtual Models',
  'models.modelName': 'Model Name',
  'models.modelNamePlaceholder': 'e.g., gpt-4-turbo',
  'models.modelNameHelp': 'Model name used in user requests',
  'models.description': 'Description',
  'models.descriptionPlaceholder': 'Optional description',
  'models.enabled': 'Enabled',
  'models.manageAssociations': 'Manage Rules',
  'models.addAssociation': 'Add Rule',
  'models.editAssociation': 'Edit Association Rule',
  'models.previewRouting': 'Preview Routing',
  'models.channel': 'Channel',
  'models.matchType': 'Match Type',
  'models.matchTypeExact': 'Exact',
  'models.matchTypePrefix': 'Prefix',
  'models.matchTypeSuffix': 'Suffix',
  'models.matchTypeContains': 'Contains',
  'models.matchTypeRegex': 'Regex',
  'models.matchTypeWildcard': 'Wildcard',
  'models.pattern': 'Pattern',
  'models.patternPlaceholder': 'e.g., gpt-4*',
  'models.patternHelp': 'Fill in the pattern according to match type',
  'models.resolvedModel': 'Resolved Model',
  'models.resolvedModelPlaceholder': 'Optional, defaults to channel model',
  'models.resolvedModelHelp': 'Leave empty to use channel configured model',
  'models.priority': 'Priority',
  'models.priorityHelp': 'Higher value = higher priority',
  'models.testModel': 'Test Model',
  'models.requestType': 'Request Type',
  'models.runPreview': 'Run Preview',
  'models.routingPreview': 'Routing Preview',
  'models.matchedRules': 'Matched Rules',
  'models.noMatchedRules': 'No matched rules',
  'models.candidateChannels': 'Candidate Channels',
  'models.noCandidates': 'No candidate channels',
  'models.virtualModel': 'Virtual Model',
  'models.noVirtualModels': 'No virtual models yet',
  'models.createFirstHint': 'Click "Create Virtual Model" button above to create your first model',
  'models.noAssociations': 'No association rules yet',
  'models.associationsCount': '{count} rules',
  'models.loadFailed': 'Failed to load virtual models',
  'models.saveSuccess': 'Saved successfully',
  'models.saveFailed': 'Failed to save',
  'models.deleteConfirm': 'Are you sure you want to delete this virtual model?',
  'models.deleteSuccess': 'Deleted successfully',
  'models.deleteFailed': 'Failed to delete',
  'models.loadAssociationsFailed': 'Failed to load association rules',
  'models.channelRequired': 'Please select a channel',
  'models.patternRequired': 'Please fill in the pattern',
  'models.nameRequired': 'Please fill in the model name',
  'models.associationSaveSuccess': 'Association rule saved successfully',
  'models.associationSaveFailed': 'Failed to save association rule',
  'models.deleteAssociationConfirm': 'Are you sure you want to delete this association rule?',
  'models.associationDeleteSuccess': 'Association rule deleted successfully',
  'models.associationDeleteFailed': 'Failed to delete association rule',
  'models.modelRequired': 'Please fill in the test model name',
  'models.previewFailed': 'Routing preview failed',
  'models.noDescription': 'No description',
  'models.pageTitle': 'Model Management',
  'models.selectChannel': 'Select Channel',
  ...
  'channels.pagination.first': 'First',
  'channels.pagination.prev': 'Previous',
  'channels.pagination.next': 'Next',
  'channels.pagination.last': 'Last',
  'channels.pagination.perPage': '/ page',
  ...
  'channels.batchEditCommonModels': 'Edit Common Models',
  'channels.batchSetPriority': 'Set Priority',
  'channels.batchDeleteChannels': 'Batch Delete',
  'channels.confirmBatchDeleteChannels': 'Are you sure you want to delete {count} selected channels? This action cannot be undone!',
  'channels.batchDeleteSummary': 'Batch delete completed: {deleted} deleted, {failed} failed, {notFound} not found',
  ...
  'settings.desc.log_channel_click_action': 'Logs page channel name click behavior',
  'settings.option.log_channel_click_action.edit': 'Edit Modal',
  'settings.option.log_channel_click_action.navigate': 'Go to Channel Page',
  ...
  'channels.batchEditCommonModelsTitle': 'Edit Common Models',
  'channels.batchEditCommonModelsDesc': '{count} channels selected, {modelCount} common models found. Changes will be applied to all selected channels.',
  'channels.batchEditColRequestModel': 'Request Model Name (editable)',
  'channels.batchEditNoCommonModels': 'No models found across selected channels',
  'channels.batchEditModelsSaved': 'Batch edit complete: {updated} updated, {unchanged} unchanged',
  ...
  'channels.batchEditStep1Desc': '{count} channels selected, {modelCount} models found (sorted by coverage). Click any model to edit.',
  'channels.batchEditStep2Desc': 'Editing model "{model}", currently in {count}/{total} channels',
  'channels.batchEditStep2NotAll': 'Some channels do not have this model — only matching channels will be updated',
  'channels.batchEditBack': 'Back to list',
  'channels.batchSetPriorityTitle': 'Set Priority in Batch',
  'channels.batchSetPriorityDesc': 'Set the same priority for {count} selected channels',
  'channels.batchSetPriorityLabel': 'Priority value',
  'channels.batchSetPriorityHint': 'Higher value = higher priority. Same priority channels are weighted by key count.',
  'channels.batchSetPriorityInvalid': 'Please enter a valid priority number',
  'channels.batchSetPrioritySaved': 'Priority set to {priority} for {count} channels',
